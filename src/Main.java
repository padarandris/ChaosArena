...
public class Main {
    public static void main(String[] args) {
        ...
        while(running){
            ...
            if (health < 1) {
                System.out.println("You limp out of the dungeon, too weak to continue fighting.");
        }
            System.out.println("-------------------------------------------------------");
            ...
            if (input.equals("1") || input.equals("1.")){
                ...
                System.out.println("You exit the dungeon as the reigning champion of Chaos Arena!");
                break GAME;
            }
